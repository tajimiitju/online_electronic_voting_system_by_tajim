				...
				<div class="row ">
					...
					<div class="menu col-md-offset-1 "> 
						<ul>
							...
							<li class="current"><a href="voters.php">voters</a></li>
	...
	<div class="container  clearfix">
		...
		<div class="two-thirds1 column">
			...
			$sadsdsds = $db->prepare("SELECT count(*) FROM voters");
				...
				$tottot=$rowaass[0];
			?>
			Total Voters: <?php echo $tottot ?><br><br>
			Voted: <?php echo $voted ?>
			<img src="pollyes.gif" width='<?php if($tottot) {echo(100*round($voted/($tottot),2)); }?>' height='20'> <?php if($tottot) { echo(100*round($voted/($tottot),2)); }?>%
			<br><br>
			Not Vote: <?php echo $notvoted ?>
			<img src="pollyes.gif" width='<?php if($tottot) { echo(100*round($notvoted/($tottot),2)); }?>' height='20'> <?php if($tottot) { echo(100*round($notvoted/($tottot),2)); }?>%
			<br><br>
			</div>
