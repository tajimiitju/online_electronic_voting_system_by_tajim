...
<body>
				...
				<div class="row ">
					...
					<div class="menu col-md-offset-1 "> 
						<ul>
							...
							<li class="current"><a href="position.php">position</a></li>
	...
	<div class="container  clearfix">
		<div class="two-thirds1 column">
			...
			<a rel="facebox" href="addposition.php"> Add Position </a>
			<table id="resultTable" data-responsive="table">
				...
				<tbody>
					...
					<tr class="record">
						...
						<td><a rel="facebox" href="editposition.php?id=<?php echo $row['id']; ?>"> Edit </a> | <a href="#" id="<?php echo $row['id']; ?>" class="delbutton" title="Click To Delete">Delete</a></td>
					</tr>
					<?php
						}
					?>
