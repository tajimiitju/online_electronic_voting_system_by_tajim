...
<body>
				...
				<div class="row ">
					...
					<div class="menu col-md-offset-1 "> 
						<ul>
							...
							<li class="current"><a href="voterinfo.php">voters info</a></li>
	...
	<div class="container  clearfix">
		...
		<div class="two-thirds1 column">
			...
			<a rel="facebox" href="addidnum.php"> Add Voter </a>
			<table id="resultTable" data-responsive="table">
				...
				<tbody>
					<?php
						...
						$result = $db->prepare("SELECT * FROM voter_list");
						$result->execute();
