...
<body>
	...
	<div class="container  clearfix">
		...
		<div class="two-thirds1 column">
			...
			<a rel="facebox" href="addparty.php"> Add Party </a>
			<table id="resultTable" data-responsive="table">
				...
				<tbody>
					...
					<tr class="record">
						...
						<td><a rel="facebox" href="editphoto.php?id=<?php echo $row['id']; ?>"><img src="partyImg/<?php echo $row['symbol']; ?>" /></a></td>
						<td><?php echo $row['description']; ?></td>
						<td><a rel="facebox" href="editparties.php?id=<?php echo $row['id']; ?>"> Edit </a> | <a href="#" id="<?php echo $row['id']; ?>" class="delbutton" title="Click To Delete">Delete</a></td>
					</tr>
					<?php
						}
					?>
