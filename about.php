			...
			<div class="row"> 
				...
				<div class="col-md-7 middle-area"> 
					<div class="content"> 
						...
						<p>“ONLINE VOTING SYSTEM” is an online voting technique. In this system people who have citizenship of Bangladesh and whose age is above 18 years of age and any people can give his/her vote online without going to any physical polling station. There is a database which is maintained by Jahangirnagar University of Bangladesh in which all the names of voters with complete information is stored.</p>
						<br>
						<p>The word “vote” means to choose from a list, to elect or to determine. The main goal of voting(in a scenario involving the citizens of a given country) is to come up with leaders of the people's choice.Most countries, Bangladesh not an exception have problems when it comes to voting. Some of the problems involved include ridging votes during election, insecure or inaccessible polling stations, inadequate polling materials and also inexperienced personnel.This online voting/polling system seeks to address the above issues. It should be noted that with this system in place, the users, citizens in this case shall be given ample time during the voting period. They shall also be trained on how to vote online before the election time. 
						</p>
