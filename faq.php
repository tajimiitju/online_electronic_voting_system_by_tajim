			...
			<div class="row"> 
				...
				<div class="col-md-7 middle-area"> 
					<div class="content"> 
						...
						<h1 class="text-center">FAQ (Frequently Asked Question)</h1>
						<div class="question-area">
							<ul>
								<li><b>How can i give vote?</b></li>
								<li class="list-unstyled">Register <i class="fa fa-arrow-right" aria-hidden="true"></i> Voting <i class="fa fa-arrow-right" aria-hidden="true"></i>Login <i class="fa fa-arrow-right" aria-hidden="true"></i> Give vote</li>
								<li><b>How to Register?</b></li>
								<li class="list-unstyled">Menu <i class="fa fa-arrow-right" aria-hidden="true"></i> Voter Registration <i class="fa fa-arrow-right" aria-hidden="true"></i> Fill up the registration form <i class="fa fa-arrow-right" aria-hidden="true"></i> Submit</li>
								<li><b>What is registration condition?</b></li>
								<li class="list-unstyled">You are eligible for the registration process only when the admin panel have your data.</li>
								<li><b>How many time i can vote?</b></li>
								<li class="list-unstyled">You can login only one time and your vote will cust for one time only. So be carefull</li>
							</ul>
						</div>
